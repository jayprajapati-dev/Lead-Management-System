...
try {
    ...
    $sql = "SELECT 
            ...
            GROUP BY ls.id, ls.name, ls.is_third_party
    ...
    foreach ($source_data as $source) {
        ...
        if ($source['avg_conversion_days'] !== null) {
            $total_conversion_days += ($source['avg_conversion_days'] * $source['converted_leads']);
            $conversion_count += $source['converted_leads'];
        }
    }
    ...
    error_log("Error fetching source data: " . $e->getMessage());
...
<head>
    ...
    <title>Lead Source Report</title>
    <!-- Bootstrap 5 CSS -->
                                            ...
                                            <?php foreach ($source_data as $source): ?>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="source-badge <?php echo $source['is_third_party'] ? 'third-party' : ''; ?>">
                                                            <?php echo $source['is_third_party'] ? 'Third Party' : 'Internal'; ?>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <?php
                                                        echo $source['avg_conversion_days'] !== null ? 
                                                            round($source['avg_conversion_days'], 1) . ' days' : 'N/A';
                                                        ?>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
